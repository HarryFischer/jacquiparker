...
export interface ArtworkSliceDefaultPrimary {
  /**
   * Artwork image field in *Artwork → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: artwork.default.primary.artwork_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  artwork_image: prismic.ImageField<never>;

  /**
   * Title field in *Artwork → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: artwork.default.primary.title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Date field in *Artwork → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: artwork.default.primary.date
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  date: prismic.KeyTextField;

  /**
   * Price field in *Artwork → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: artwork.default.primary.price
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ContactFormSliceDefaultPrimary {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.default.primary.formid
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Primary content in *Portrait → Default → Primary*
 */
export interface PortraitSliceDefaultPrimary {
  /**
   * Image field in *Portrait → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: portrait.default.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
...
/**
 * Default variation for Portrait Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type PortraitSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<PortraitSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Portrait*
 */
type PortraitSliceVariation = PortraitSliceDefault;

/**
 * Portrait Shared Slice
 *
 * - **API ID**: `portrait`
 * - **Description**: Portrait
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type PortraitSlice = prismic.SharedSlice<
  "portrait",
  PortraitSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      PortraitSlice,
      PortraitSliceDefaultPrimary,
      PortraitSliceVariation,
      PortraitSliceDefault,
      QuoteSlice,
